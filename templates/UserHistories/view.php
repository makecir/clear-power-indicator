...
$tweet_text = $userHistory->user->user_detail->dj_name.'さんがCPIを更新しました：CPI'.$userHistory->rating_cur_info.' ('.$userHistory->rating_diff_info.") 推定".$userHistory->standing_cur_info."位(".$userHistory->standing_diff_info.")\n";
