<div class="users view content">
            ...
            <div class="password change form content">
                ...
                <fieldset>
                    <div class="mb-5">
                        ...
                        <?= $this->Form->control('follow_pass',['label' => '合言葉', 'class' => 'form-control', 'type' => 'text', 'placeholder'=>'follow', 'required' => true]); ?>
                        <small class="form-text text-muted mb-0">アルファベットまたはアンダーバーからなる4字以上16字以下の文字列</small>
                        <small class="form-text text-muted mb-3">denied と設定すると、全てのフォローを拒否します。</small>
                    </div>
                    <div class="mb-5">
    ...
    <div class="card border-secondary mb-3">
        ...
        <div class="card-body text-dark pr-4 pl-4">
            <p>
                アカウントを削除すると、登録したユーザー情報・ランプ・更新履歴・フォロー関係は全て削除されます。</br>
